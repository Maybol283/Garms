...
function ShopBase() {
  return (
    <section className="snap-start md:h-screen h-fit bg-palette-1 grid grid-cols-2 md:flex gap-x-2 md:flex-row justify-center items-center px-4 sm:py-48 md:py-12 gap-4 md:mt-20 md:space-y-0">
      {cardItems.map((item, index) => (
        ...
        >
          <p className="absolute text text-white font-bold mb-20">{item.alt}</p>
          <img
            src={item.src}
